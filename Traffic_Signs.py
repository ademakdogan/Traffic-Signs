# -*- coding: utf-8 -*-
"""
Created on Mon Sep 30 17:55:32 2019
...
#Open pickle train/test/valid data
...
plt.imshow(grayscale(X_train[1000]),cmap = plt.get_cmap("gray"))
plt.axis("off")
print(grayscale(X_train[1000]).shape)
...
#Each image in x_train/x_test/x_val is mapped
...
#One Hot encoding to our data labels
